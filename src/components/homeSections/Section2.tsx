  ...
  return (
    <div className="w-full h-screen border-b text-white/70 border-white/20 flex flex-col justify-center items-center text-[25px] gap-[5%] pb-[2%]">
      ...
      <div className="w-full h-[80%] py-[2%] flex justify-between items-center gap-[2%] ">
        <div className="w-[33%] h-full flex flex-col p-[1%] justify-around items-start border border-white/20 rounded-4xl shadow-indigo-600/30 shadow-xl bg-white/2">
            <img src="src/assets/AvalonTest.png" className="w-full h-[40%] rounded-2xl " />
            <h2>Avalon</h2>
            <p>E-Commerce Site Computer Shop of Future with Canva Self Configurator and more </p>
            <div className="w-full h-[10%] flex gap-[2%] p-[2%]">
                <div className="w-auto h-full p-[1%] px-[3%] rounded-2xl bg-white/10">
                    React
                </div>
                <div className="w-auto h-full p-[1%] px-[3%] rounded-2xl bg-white/10">
                    Javascript
        ...
        <div className="w-[33%] h-full flex flex-col p-[1%] justify-around bg-white/2 items-start border border-white/20 rounded-4xl shadow-indigo-600/30 shadow-xl">
             <img src="src/assets/BackshotlibsTest.png" className="w-full h-[40%] rounded-2xl " />
            <h2>BackShotLibs</h2>
            <p>Online web Music Listening tool free use base-friendly New Style structured</p>
            <div className="w-full h-[10%] flex gap-[2%] p-[2%]">
                <div className="w-auto h-full p-[1%] px-[3%] rounded-2xl bg-white/10">
                    React
                </div>
        ...
        <div className="w-[33%] h-full flex flex-col p-[1%] justify-around items-start bg-white/2 border border-white/20 rounded-4xl shadow-indigo-600/30 shadow-xl">
             <img src="src/assets/ManjiKeyTest.png" className="w-full h-[40%] rounded-2xl " />
            <h2>ManjiKey</h2>
            <p>E-Commerce Site keyboard Shop Base friendly avaible for orders and more</p>
            <div className="w-full h-[10%] flex gap-[2%] p-[2%]">
                <div className="w-auto h-full p-[1%] px-[3%] rounded-2xl bg-white/10">
                    React
                </div>
