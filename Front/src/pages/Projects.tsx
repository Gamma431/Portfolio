...
export default function Projects() {
  return (
    <motion.div  variants={pageVariants} initial="initial"  animate="animate"  exit="exit" transition={{duration: 0.3, ease: "easeInOut",}} className="w-full  h-auto p-[2%] /70 pt-[7%]" >
      <h1 className="text-[40px] text-center md: mt-[20%]">My Projects</h1>
