  ...
  return(
    <section className="w-full min-h-screen theme-bg theme-text relative overflow-hidden flex flex-col lg:flex-row justify-center items-center gap-[6%] px-[5%] pt-[14vh] pb-[7%]">
      ...
      <div className="w-full lg:w-[52%] min-h-[50vh] flex flex-col justify-center items-center lg:items-start text-center lg:text-left relative z-10">
        ...
        <h1 className="text-[76px] md:text-[112px] lg:text-[140px] font-black leading-none text-transparent bg-clip-text bg-linear-to-r from-purple-400 via-indigo-400 to-blue-400">
          Arman
        </h1>
        ...
        <div className="w-full flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mt-9">
          <Link to="/projects" className="w-full sm:w-[210px] h-[62px] rounded-[22px] bg-linear-to-r from-purple-600 via-indigo-600 to-blue-600 text-white font-bold flex justify-center items-center shadow-lg shadow-indigo-900/30 hover:scale-[1.03] active:scale-[0.98] transition-all duration-300">
            View Projects
          </Link>
