...
export default function Contact(){
  ...
  return(
    <main className="w-full min-h-screen px-[5%] pt-[14vh] pb-[7%] relative overflow-hidden theme-bg theme-text">
      ...
      <section className="w-full relative z-10 flex flex-col gap-12">
        ...
        <div className="w-full text-center lg:text-left flex flex-col gap-4">
          ...
          <h1 className="text-[46px] md:text-[68px] lg:text-[82px] font-black leading-none grad-text-primary">Get In Touch</h1>
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-[0.9fr_1.4fr] gap-7 lg:gap-9">
          ...
          <form onSubmit={handleSubmit} className="rounded-[35px] border theme-border theme-card backdrop-blur-xl theme-shadow p-6 md:p-8 lg:p-10 flex flex-col gap-6">
            ...
            <button disabled={loading} className="w-full md:w-fit px-8 py-4 rounded-[22px] grad-bg-primary text-white font-bold shadow-lg shadow-indigo-900/30 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300">
